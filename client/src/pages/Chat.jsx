...
function Chat() {
  ...
  const [activeInteraction, setActiveInteraction] = React.useState(null);
  const userMessages = [
    {
  ...
  return (
    <div className="flex w-full h-full bg-[#F6F6F6]">
      <Navbar />
      <ChatArea  activeInteraction={activeInteraction} setActiveInteraction={setActiveInteraction} totalMessages={totalMessages} setTotalMessages={setTotalMessages} />
      <MyChat activeInteraction={activeInteraction} setActiveInteraction={setActiveInteraction} totalMessages={totalMessages} setTotalMessages={setTotalMessages} />
    </div>
  );
}
